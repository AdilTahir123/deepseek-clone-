    ...
    <div className="flex h-screen">
      ...
      <div className=" flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
        ...
        {messages.length == 0 ? (
          ...
          <div ref={containerRef} className="relative flex flex-col items-center justify-start w-full mt-20 max-h-screen overfolw-y-auto">
            <p className="fixed top-8 border border-transparent hover:boder-gray-500/50 py-1 px-2 rounded-lg font-semibold mb-6">
              {selectedChat.name}
            </p>
